...
#import "PrivatePutViewController.h"

@interface PrivatePutViewController ()
- (void)initRequestBundle;
@end

@implementation PrivatePutViewController

NSString *const API_PUT_URL = @"/rs/exam/modify";
...
- (void)initRequestBundle
{
    NSString *payload = [NSString
     ...
     [reqBundle setUrl:[ESMART_URL_OAUTH_SERVER stringByAppendingString:API_PUT_URL]];
    [reqBundle setHttpMethod:eSmartHttpMethodPUT];
