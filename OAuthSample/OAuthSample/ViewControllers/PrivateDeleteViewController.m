...
#import "PrivateDeleteViewController.h"

@interface PrivateDeleteViewController ()
- (void)initRequestBundle;
@end

@implementation PrivateDeleteViewController

NSString *const API_DELETE_URL = @"/rs/exam/remove";
...
- (void)initRequestBundle
{
    [reqBundle setUrl:[ESMART_URL_OAUTH_SERVER stringByAppendingString:API_DELETE_URL]];
    [reqBundle setHttpMethod:eSmartHttpMethodDELETE];
