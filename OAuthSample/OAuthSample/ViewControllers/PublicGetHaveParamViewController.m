...
#import "PublicGetHaveParamViewController.h"

@interface PublicGetHaveParamViewController ()
- (void)initRequestBundle;
@end

@implementation PublicGetHaveParamViewController

NSString *const API_PUBLIC_PARAM_URL = @"/rs/exam/test";
...
- (void)initRequestBundle
{
    ...
    [param setValue:@"H1AGA3" forKey:@"userId"];
    
    [reqBundle setUrl:[ESMART_URL_OAUTH_SERVER stringByAppendingString:API_PUBLIC_PARAM_URL]];
